...
現在のリポジトリバージョンは `0.9.0` です。バージョンごとの変更詳細、各修正と対応するアップストリーム commit、独立タスクへ繰り延べた項目は `CHANGELOG.md`、`docs/upstream-sync-0.9.0.md`（0.9.0 同期の commit ごとの追跡）および `docs-dev/web-parity-post-3.14-2026-05.md` を参照してください。
