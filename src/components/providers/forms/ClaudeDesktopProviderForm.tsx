...
import type { ClaudeDesktopDefaultRoute } from "@/types/claudeDesktop";
import { resolveManagedAccountId } from "@/lib/authBinding";
import { useManagedAuth } from "./hooks";
...
export function ClaudeDesktopProviderForm({
  ...
  const { data: defaultRoutes = [] } = useQuery({
    ...
    queryFn: () => claudeDesktopApi.getDefaultRoutes(),
  });
