...
当前仓库版本为 `0.9.0`。逐版变更明细、每条修复对应的上游 commit、被延后到独立任务的项，见 `CHANGELOG.md`、`docs/upstream-sync-0.9.0.md`（0.9.0 同步逐 commit 跟踪）与 `docs-dev/web-parity-post-3.14-2026-05.md`。
